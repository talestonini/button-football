...
class TeamEntity(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<TeamEntity>(TeamsTable)

    var name by TeamsTable.name
    var type by TeamTypeEntity referencedOn TeamsTable.codType
    var fullName by TeamsTable.fullName
    var foundation by TeamsTable.foundation
    var city by TeamsTable.city
    var country by CountryEntity referencedOn TeamsTable.codCountry
