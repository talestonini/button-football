...
class ChampionshipEntity(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<ChampionshipEntity>(ChampionshipsTable)

    var type by ChampionshipTypeEntity referencedOn ChampionshipsTable.codType
    ...
    var status by ChampionshipStatusEntity referencedOn ChampionshipsTable.codStatus
